...
<body>
	...
	<!-- pop-up // 데이터 선택 시, 대화내용 팝업  // -->
	<div id="dataLayer" class="pop wrap-pop jqx-window jqx-popup" style="position: absolute; top: 30rem; left: calc(50% - 20rem); width: 40rem; display:none;">
		<div id="" class="pop-header jqx-window-header">
			<h1>Communication Data</h1>
			<div class="jqx-window-close-button-background">
				<div class="jqx-window-close-button jqx-icon-close" id="btnHide"></div>
			</div>
		</div>
