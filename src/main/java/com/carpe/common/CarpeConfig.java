...
public class CarpeConfig {
  ...
  private static String EVDNC_SIMILARITY_PATH;
  ...
  @Value("#{carpe_config['evdnc.similarity.path']}")
  public void setEvdncSimilarityPath(String path) {
    EVDNC_SIMILARITY_PATH = path;
  }
  ...
  public static String getEvdncSimilarityPath() {
    return EVDNC_SIMILARITY_PATH;
  }
